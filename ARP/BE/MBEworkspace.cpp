...
int32_t BucketElimination::MBEworkspace::ComputeOutputFunctions(bool DoMomentMatching, signed char approx_bound, int64_t & TotalSumOutputFunctionsNumEntries)
{
	TotalSumOutputFunctionsNumEntries = 0 ;

//	printf("In compute Output Function --");
	int32_t i ;
