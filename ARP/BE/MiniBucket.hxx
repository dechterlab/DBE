...
//    int32_t nSamples = 1000;
        ...
        int32_t
        ComputeOutputFunction_NN(int32_t varElimOperator, ARE::Function *FU, ARE::Function *fU, double WMBEweight,
                                 int64_t h_dim, int64_t bs, double lr, int64_t num_epochs, int64_t n_layers);
    } ;
